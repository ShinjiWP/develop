<article class="p-grid--article u-space--content">
  <img class="c-image p-content__image" src="<?php echo esc_url(get_theme_file_uri());?>/image/png/main-visual-1_sp.png"
    alt="" />
...
<article class="p-grid--article">
  <img class="c-image p-content__image" src="<?php echo esc_url(get_theme_file_uri());?>/image/png/main-visual-2_sp.png"
    alt="" />
