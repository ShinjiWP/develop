  ...
  <div class="p-grid--mainvisual">
    <div class="p-mainvisual--image">
      <img class="c-image p-mainvisual--image--sp"
        src="<?php echo esc_url(get_theme_file_uri());?>/image/png/top-image-front-sp.png" alt="ダミーサイト" />
      <img class="c-image p-mainvisual--image--tab"
        src="<?php echo esc_url(get_theme_file_uri());?>/image/png/top-image-front-tab.png" alt="ダミーサイト" />
      <img class="c-image p-mainvisual--image--pc"
        src="<?php echo esc_url(get_theme_file_uri());?>/image/png/top-image-front-pc.png" alt="ダミーサイト" />
    </div>
